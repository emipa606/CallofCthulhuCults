    ...
    public partial class Building_SacrificialAltar : Building, IBillGiver
    {
        ...
        public IntVec3 GetLyingSlotPos()
        {
            ...
            return Rotation == Rot4.East
                ...
                : Rotation == Rot4.South ? new IntVec3(cellRect.minX + index, Position.y, cellRect.maxZ) : new IntVec3(cellRect.maxX, Position.y, cellRect.maxZ - index);
        }
...
|| (tempCurrentSpell.Worker is SpellWorker worker && worker.CanSummonNow(Map));
...

        {
            ...
            RecipeDef recipe = DefDatabase<RecipeDef>.GetNamed(recipeDefName);
            resultRecipe = recipe;
